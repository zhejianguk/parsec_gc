...
path_firesim_sw_workloads=${path_firesim_sw}/gc-workloads/gc-fed/overlay/root
...
cd ${path_firesim_sw}
cmd="./marshal clean gc-workloads/gc-fed.json"
echo "${cmd}"
eval ${cmd}

cmd="./marshal build gc-workloads/gc-fed.json"
echo "${cmd}"
eval ${cmd}
